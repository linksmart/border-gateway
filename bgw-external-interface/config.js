...
let config = {
    ...
    servers:
            [
                {
                    name: "http_proxy",
                    bind_addresses: config_file.http_external_interface_bind_addresses,
                    bind_port: config_file.http_external_interface_bind_port,
                    dest_port: config_file.http_proxy_bind_port,
                    dest_address: config_file.http_proxy_bind_addresses[0],
                    allowed_addresses: []
                },
                {
                    name: "mqtt_proxy",
